...
const List = React.memo(({id, title, completed, todoData, setTodoData, provided, snapshot, handleClick}) => {
        ...
        if (isEditing) {
            return (
                <div
                    className={`bg-gray-100 flex items-center justify-between w-full px-5 py-1 my-2 text-gray-600 bg-gray-100 boarder rounded`}>
            ...
            return (
                <div key={id} {...provided.draggableProps}
                     ...
                     className={`${snapshot.isDragging ? "bg-gray-400" : "bg-gray-100"} 
                                                  flex items-center justify-between w-full px-5 py-1 my-2 text-gray-600 bg-gray-100 boarder rounded`}>
                    <div className="items-center">
